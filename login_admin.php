                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="htc__login__register__wrap">
                            ...
                            <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                                <form action="traitement_login_admin.php" class="login" method="post">
                                ...
                                <a href="login-register.php" style="text-size:20px">En tant que client </a>  
                                </div>
                            ...
                            <div id="register" role="tabpanel" class="single__tabs__panel tab-pane fade">
                                <form action="traitement_inscription_admin.php" class="login" method="post">
                                    <input type="text" placeholder="Name*" name="nom_admin">
