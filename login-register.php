                                ...
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="#">pages</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="#">testimals <span><i class="zmdi zmdi-chevron-right"></i></span></a>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="htc__login__register__wrap">
                            ...
                            <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                                <form action="traitement_login_client.php" class="login" method="post">
                                    <input type="text" placeholder="User Name*" name="nom_client">
                                    <input type="password" placeholder="Password*" name="pass_client">
                                ...
                                <div class="tabs__checkbox" style="margin-left: 35%;">
                                    <a href="login_admin.php" style="text-size:20px">En tant qu'admin </a>  
                                </div>
                            ...
                            <div id="register" role="tabpanel" class="single__tabs__panel tab-pane fade">
                                <form action="traitement_inscription_client.php" class="login" method="post">
                                    <input type="text" placeholder="Name*" name="nom_inscript">
                                    <input type="email" placeholder="Email*" name="mail_inscript">
                                    <input type="password" placeholder="Password*" name="mdp_inscript">
