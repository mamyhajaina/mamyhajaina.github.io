...
include("connexion.php");
    ...
    $sql2="select SUM(prix*quantite)  from panier_voiture where id_client is NULL";
                        ...
                        <form action="testconnexion.php" method="post">               
                            <div class="table-content table-responsive">
                                <table>
                                    <thead>
                                    <tr>
                                            <th class="product-remove">ACHAT</th>
                                            <th class="product-name">PRIX</th>
                                            <th class="product-price" >QUANTITE</th>
                                    </tr>
                                        <!-- <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <h2><?php echo $row['marques'] ?> &nbsp;<?php echo $row['nom'] ?></h2></td>
                                            <td> <h2> <?php echo $row['prix'] ?> </h2> </td>
                                            <td > <h2> <?php echo $row['quantite'] ?></h2></td>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-7 col-xs-12">
                                    <div class="wc-proceed-to-checkout">
                                        <a href="modifier_achat.php">Modifier Panier</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="cart_totals">
                                        ...
                                        <table>
                                            <tbody>
                                                    ...
                                                    <th>Total</th>
                                                    <td>
                                                        <strong><span class="amount"><?php while ($ligne = mysqli_fetch_assoc($result2)) { ?> <?php echo $ligne['SUM(prix*quantite)'] ?> Ariary  <?php } ?></span></strong>
                                                    </td>
                                                </tr>                                           
                                            </tbody>
                                        </table>                                        
                            ...
                            <div class="row mt--60">
                                <div class="col-md-12">
                                    <div class="htc__loadmore__btn">
                                        <input type="submit" name="submit" value="VALIDER ACHAT" style="color:white;background-color:black;height:75px;width:300px">
                                    </div>
                                </div>
                            </div>
                        </form> 
