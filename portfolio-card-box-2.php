                    ...
                    <div class="row grid">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 grid-item cat5 cat2">
                            <div class="single-portfolio-card mb--30">
                                <div class="portfolio-img">
                                    <a href="single-portfolio.php">
                                        <img src="images/product/Categorie/<?php echo selectdetaile(2)['photos'] ?>" alt="" />
                                    </a>
                                    <div class="portfolio-icon">
                                        <a class="video-popup" href="https://www.youtube.com/watch?v=L4j0o2IqLKE&list=PL3rQmUJKNFd7bakRTEiUG_-V1bhl3mTTU">
                                            <i class="zmdi zmdi-videocam"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="portfolio-title portfolio-card-title text-center">
                                    <h3><a href="single-portfolio.php">Nissan</a></h3>
                                    <span>Video</span>
                                </div>				
                            </div>						
                        </div>
